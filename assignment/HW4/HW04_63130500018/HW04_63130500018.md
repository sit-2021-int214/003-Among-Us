...
2. [Learning function from Tidyverse](./Tidyverse.md)
3. [Transform data with dplyr and finding insight the data](./Transfrom)
4. [Visualization with GGplot2](./Visual.md)
